...
Route::prefix('admin')->namespace('Admin')->group(function(){
    ...
    Route::group(['middleware'=>['auth:admin']], function(){
       ...
       //Brand Route
       Route::get('/all-brand/{page}', 'BrandController@brands');
       ...
       //ProductAttributes
       Route::post('/add-product-attributes/{id}', 'ProductController@addAttributes');
       Route::get('/all-atributes/{id}', 'ProductController@allAttributes');
       Route::post('/status-attribute', 'ProductController@statusAttribute');
       Route::get('/delete-product-attribute/{id}', 'ProductController@deleteAttribute');
    });
});
