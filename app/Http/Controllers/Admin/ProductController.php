...
class ProductController extends Controller
{
        ...
        if($request->isMethod('post')){
            ...
            if (!empty($value)) {
              ...
              if ($skuCount>0) {
                return response()->json([
                    'success'=>false,
                    'errors'=>['msg'=>['SKU alredy exists. Please add another SKU']],
                ],400);
              }
              ...
              if ($sizeCount>0) {
                return response()->json([
                    'success'=>false,
                    'errors'=>['msg'=>['Size alredy exists. Please add another Size']],
                ],400);
              }
    ...
    public function allAttributes($id)
    {
        $attributes = ProductAttribute::orderBy('id','desc')->where('product_id',$id)->get();
        return response()->json([
            'success'=>true,
            'response'=>$attributes,
        ], 200);
